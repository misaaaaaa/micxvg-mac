...
void playIntro()
{
    ...
    sonido(0, 500, 100, 50);  // Pin 2
    sonido(1, 600, 100, 50);  // Pin 3
    sonido(2, 700, 100, 50);  // Pin 4
    sonido(3, 800, 100, 50);  // Pin 5
    sonido(4, 900, 100, 50);  // Pin 6
    sonido(5, 1000, 100, 50); // Pin 7
    sonido(6, 1100, 100, 50); // Pin 8
    sonido(7, 1200, 100, 50); // Pin 10
    sonido(8, 1300, 100, 50); // Pin 11
    sonido(9, 1400, 100, 50); // Pin 12

    sonido(0, 500, 200, 50);  // Pin 2
    sonido(1, 600, 200, 50);  // Pin 3
    sonido(2, 700, 200, 50);  // Pin 4
    sonido(3, 800, 200, 50);  // Pin 5
    sonido(4, 900, 200, 50);  // Pin 6
    sonido(5, 1000, 200, 50); // Pin 7
    sonido(6, 1100, 200, 50); // Pin 8
    sonido(7, 1200, 200, 50); // Pin 10
    sonido(8, 1300, 200, 50); // Pin 11
    sonido(9, 1400, 200, 50); // Pin 12
